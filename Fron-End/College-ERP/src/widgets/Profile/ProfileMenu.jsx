  ...
  return (
    <Menu open={openMenu} handler={setOpenMenu} placement="bottom-end">
      <MenuHandler>
        ...
        >
          <div className="flex items-center justify-center rounded-full bg-blue-500 text-white font-semibold w-8 h-8 md:w-10 md:h-10 hidden lg:flex">
            {(user.studName || user.name || "U").charAt(0).toUpperCase()}
          </div>
